...
Word16 t_qua_gain6b[NB_QUA_GAIN6b*2] = {
   1566,  1332,
   1577,  3557,
   3071,  6490,
   4193, 10163,
...
Word16 t_qua_gain7b[NB_QUA_GAIN7b*2] = {
    204,   441,
    464,  1977,
    869,  1077,
   1072,  3062,
...
#define PRED_ORDER   4
Word16 pred[PRED_ORDER] = {4096, 3277, 2458, 1638};
...
Word16 isf_init[M] =
{
   ...
   0x2400, 0x2800, 0x2c00, 0x3000, 0x3400, 0x3800, 0x3c00,  0xf00
};
