...
{
    CSL_I2C_0_REGS->ICMDR = 0x400;		// Master mode, Reset I2C
    CSL_I2C_0_REGS->ICPSC = 20;			// Config prescaler for 12MHz
    CSL_I2C_0_REGS->ICCLKL= 20;			// Config clk LOW for 20kHz
    CSL_I2C_0_REGS->ICCLKH= 20;			// Config clk HIGH for 20kHz
