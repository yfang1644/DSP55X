...
Word16 dico21_isf_36b[SIZE_BK21_36b*5] = {
   -52,   -96,   212,   315,   -73,
    82,  -204,   363,   136,  -197,
  -126,  -331,   183,   218,   143,
   -49,   -41,   557,   230,    72,
...
Word16 dico22_isf_36b[SIZE_BK22_36b*4] = {
  -298,    -6,    95,    31,
  -213,   -87,  -122,   261,
     4,   -49,   208,    14,
  -129,  -110,    30,   118,
...
Word16 dico23_isf_36b[SIZE_BK23_36b*7] = {
...
)
{
    ...
    {                                      /* bad frame */
        ...
        for (i = 0; i < ORDER; i++)
        {
            ...
            tmp = mult(past_isfq[i], MU);
            tmp = add(tmp, ref_isf[i]);               /* predicted ISF */
