...
#define TX_SPEECH 1
#define TX_SID_FIRST 2
#define TX_SID_UPDATE 4
#define TX_NO_DATA 8

#define RX_SPEECH_GOOD 1
#define RX_SPEECH_PROBABLY_DEGRADED 2
#define RX_SPEECH_LOST 4
#define RX_SPEECH_BAD 8
#define RX_SID_FIRST 16
#define RX_SID_UPDATE 32
#define RX_SID_BAD 64
#define RX_NO_DATA 128
