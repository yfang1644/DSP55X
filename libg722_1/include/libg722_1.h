...
#define	MAX_DCT_LENGTH_LOG		(MAX_BANDWIDTH/7+5)	/* bandwidth of 14k */
#define	MAX_DCT_LENGTH			(5*(1<<MAX_DCT_LENGTH_LOG))
#define	MAX_NUMBER_OF_REGIONS	(MAX_BANDWIDTH*2)
#define	MAX_NUMBER_OF_VALID_COEFS	(MAX_NUMBER_OF_REGIONS * REGION_SIZE)
#define	MAX_NUM_CATEGORIZATION_CONTROL_BITS (MAX_BANDWIDTH/7+3)
