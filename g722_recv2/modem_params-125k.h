...
%%	MOD_type	Rsymb(sps)	Fdev(Hz)	RXBW(Hz)	Mancheste	AFC_en	Rsymb_error	Chip-Version
 	3	125000	62500	200000	0	0	0.0	3
...
#define DEVIATION 62500
#define DATA_RATE 125000
...
// Mod type: 2GFSK,	DataRate: 125.00 ksps;  FreqDev: 62.50 kHz;  RX BW: 250.00 kHz

// all for TX in this section:
// DataRate: 3 API bytes;  NCOMODulus: 4 bytes; FreqDev: 3 bytes, for TX
#define MODEM_DATA_RATE_2_14 0x11, 0x20, 0x0A, 0x03, 0x03, 0xD0, 0x90, 0x08, 0x2D, 0xC6, 0xC0, 0x00, 0x11, 0x11
...
#define MODEM_BCR_OSR_1_14 0x11, 0x20, 0x0A, 0x22, 0x00, 0x50, 0x06, 0x66, 0x66, 0x06, 0x66, 0x02, 0x00, 0x00
// AFC: 8 bytes,  for (G)FSK RX
#define MODEM_AFC_GEAR_12 0x11, 0x20, 0x08, 0x2C, 0x00, 0x23, 0x88, 0x89, 0x00, 0xE1, 0xA0, 0x00

// AGC: 4 bytes,  for all RX
#define MODEM_AGC_CONTRL_5 0x11, 0x20, 0x01, 0x35, 0xE2
#define MODEM_AGC_WINDOW_SIZE_7 0x11, 0x20, 0x03, 0x38, 0x11, 0x12, 0x12
...
// raw: 4 bytes, for RX
#define MODEM_RAW_SEARCH_8 0x11, 0x20, 0x04, 0x44, 0xD6, 0x03, 0x01, 0x8F
...
// RX chfil coeff:  WB filter k1=2 (BW=274.8 kHz), NB filter k2=2 (BW=274.8 kHz)
