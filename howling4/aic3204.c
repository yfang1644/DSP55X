...
//	EZDSP5535_waitusec(10000); // Wait for PLL to come up
	...
	AIC3204_rset( 65, 20);  // Left DAC gain to 10dB VOL
	AIC3204_rset( 66, 20);  // Right DAC gain to 10dB VOL
	AIC3204_rset( 63, 0xd4 );  // Power up left,right data paths and set channel
	AIC3204_rset( 81, 0xc0 );  // Powerup Left and Right ADC
	AIC3204_rset( 82, 0x00 );  // Unmute Left and Right ADC, fine gain=0dB
	AIC3204_rset( 83, 40 );  // Left ADC gain, -12dB~+20dB, 01100111~00101000, stepsize 0.5dB
	AIC3204_rset( 84, 40 );  // Right ADC gain, -12dB~+20dB, 01100111~00101000, stepsize 0.5dB
