...
***************************************************************************/
Int16 old_decoder_mlt_coefs[DCT_LENGTH];
             ...
             Int16 *p_old_mag_shift)
{
    ...
    Uint16 categorization_control = 0;
    Int16  number_of_coefs = DCT_LENGTH;
    Int16  number_of_valid_coefs = NUMBER_OF_VALID_COEFS;
