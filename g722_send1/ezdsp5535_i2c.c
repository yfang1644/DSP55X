 ...
 */
Int16 EZDSP5535_I2C_write( Uint16 i2c_addr, Int8* data, Uint16 len )
{
	Int16 timeout, i;
 ...
 *      Uint16 len         <- # of bytes to write
 */
Int16 EZDSP5535_I2C_read( Uint16 i2c_addr, Int8* data, Uint16 len )
{
    Int16 timeout, i;
	Int16 i2c_timeout = 0x7fff;
