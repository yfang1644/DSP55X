 ...
 */
unsigned long mad_bit_length(struct mad_bitptr const *begin,
			    struct mad_bitptr const *end)
{
  return begin->left - end->left + CHAR_BIT * (end->byte - begin->byte);
}
 ...
 */
void mad_bit_skip(struct mad_bitptr *bitptr, unsigned short len)
{
 ...
 */
unsigned long mad_bit_read(struct mad_bitptr *bitptr, unsigned short len)
{
	unsigned long value;
 ...
 */
unsigned short mad_bit_crc(struct mad_bitptr bitptr, unsigned short len,
			   unsigned long init)
{
	unsigned short crc;
	unsigned long msb;
